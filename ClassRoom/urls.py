...
urlpatterns = [
    ...
    path('add_group/<str:shenase>/<str:assignment_id>' ,AddGroup.as_view()),
    path('add_question/<str:shenase>/<str:assignment_id>' ,AddQuestionFromBank.as_view()),
    path('question/<str:shenase>/<str:assignment_id>/<str:question_id>' ,QuestionView.as_view()),
    path('submition/<str:shenase>/<str:assignment_id>' ,GiveMark.as_view()),
    path('scoreboard/<str:shenase>/<str:assignment_id>' ,ScoreBoard.as_view()),
]